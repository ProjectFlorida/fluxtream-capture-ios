...
#define DEFAULTS_USERNAME @"bodytrack_username"
#define DEFAULTS_PASSWORD @"bodytrack_password"
#define DEFAULTS_SERVER @"bodytrack_server"
#define DEFAULTS_FIRSTRUN @"bodytrack_firstrun"
...
#define DEFAULTS_PHOTO_ORIENTATION_SETTINGS_CHANGED @"bodytrack_photo_orientation_settings_changed"
